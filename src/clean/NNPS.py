...
for file in files:
    ...
    # NOTA: ME SALTO DE LA LÍNEA 122 A LA 131 DEL CÓDIGO MATLAB
...
plt.imshow(NPS, cmap='gray')  # Display the original image
plt.colorbar()  # Display a color bar
plt.title('NPS')  # Title of the figure
plt.show()

print('Hey, estamos en la línea 171!')
...
print('Hey estamos en la fila 225')
# Removing NaN values
...
# NPS Plot
print("Hey, vamos a dibujar los NPS!")
plt.figure()
plt.plot(verticalFrequencies, NPS_vertical, 'r', label='NPS Vertical')
plt.plot(horizontalFrequencies, NPS_horizontal, 'b', label='NPS Horizontal')
plt.legend()
